...
# Valentines Design System

## Philosophy

Valentines is not a traditional educational application.

Valentines is an emotional learning platform designed for children.
...
Valentines must reward effort, not only correctness.
...
Landing tokens MUST be compatible with Next.js runtime style consumption.
